...
SELECT
	...
	NVL(SUM(SEJOUR.NB_PERSONNES),0) AS NBR_TOTAL_PERSONNES,
	RESERV.NO_CLIENT,
...
GROUP BY
	...
	TYPE_LOGEMENT.DESCRIPTION
HAVING
	NVL(SUM(GREATEST(LEAST(RESERVATION.FIN_SEJOUR, TO_DATE('23-03-2015', 'dd-mm-yyyy')), TO_DATE('17-03-2015', 'dd-mm-yyyy')) - LEAST(GREATEST(RESERVATION.DEBUT_SEJOUR, TO_DATE('17-03-2015', 'dd-mm-yyyy')), TO_DATE('23-03-2015', 'dd-mm-yyyy'))), 0) = 0
ORDER BY
	LOGEMENT.NO_LOGEMENT;
/*=========================================================================================================
	13
...
SELECT
	VILLAGE.PAYS,
	VILLAGE.NOM_VILLAGE,
	MAX(NVL(SUM(GREATEST(LEAST(RESERVATION.FIN_SEJOUR, TO_DATE('31-03-2015', 'dd-mm-yyyy')), TO_DATE('01-03-2015', 'dd-mm-yyyy')) - LEAST(GREATEST(RESERVATION.DEBUT_SEJOUR, TO_DATE('01-03-2015', 'dd-mm-yyyy')), TO_DATE('31-03-2015', 'dd-mm-yyyy'))), 0)) AS DUREE_OCCUPATION
FROM
	VILLAGE
		INNER JOIN RESERVATION
