...
SELECT
	SEJOUR.NO_LOGEMENT,
	GREATEST(0, SUM(LEAST(RESERVATION.FIN_SEJOUR, TO_DATE('31-03-2015', 'dd-mm-yyyy')) - GREATEST(RESERVATION.DEBUT_SEJOUR, TO_DATE('01-03-2015', 'dd-mm-yyyy')))) AS DUREE_OCCUPATION
FROM
	SEJOUR
		INNER JOIN RESERVATION
			ON SEJOUR.NO_RESERVATION = RESERVATION.NO_RESERVATION AND
...
/*=========================================================================================================*/
SELECT
	SUM(LEAST(RESERVATION.FIN_SEJOUR, TO_DATE('31-03-2015', 'dd-mm-yyyy')) - GREATEST(RESERVATION.DEBUT_SEJOUR, TO_DATE('01-03-2015', 'dd-mm-yyyy'))) / 16 * 100 || '%' AS TAUX_OCCUPATION,
